...
export default function WalletButton() {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      {open && (
        <div style={{ position: "absolute", right: 0, top: "calc(100% + 8px)", background: "#1B3A41", border: "1px solid rgba(179,199,195,0.18)", borderRadius: 10, padding: 8, minWidth: 200, zIndex: 100, boxShadow: "0 8px 32px rgba(0,0,0,0.4)" }}>
